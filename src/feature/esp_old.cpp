...
// ΓöÇΓöÇ Crosshair (ported from omc0eg) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
static float xhair_anim_rot(float t) {
    // 5-second cycle: sweeps 0ΓåÆ105┬░ΓåÆ90┬░ΓåÆ-25┬░ΓåÆ0┬░
...
void esp::crosshair(ImDrawList* dl)
{
    ...
    if (global::crosshair::Position == 0) {
        // Follow cursor ΓÇö hide the Windows cursor so the crosshair replaces it
...
// ΓöÇΓöÇ Tracers / Snaplines (ported from omc0eg) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
void esp::tracers(ImDrawList* dl, const std::vector<sdk::player>& players)
{
    ...
    for (auto& player : players) {
        ...
        switch (global::tracer::Dest) {
            ...
            case 3: { // My Head ΓÇö line goes FROM local head TO enemy head, like a cursor-follow tracer
