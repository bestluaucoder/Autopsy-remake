...
namespace offsets {
    ...
    inline constexpr uintptr_t HumanoidHealthDisplayDistance = 0x18c;
    ...
    inline constexpr uintptr_t LightingAmbient = 0xc8;
    inline constexpr uintptr_t LightingBrightness = 0x110;
    ...
    inline constexpr uintptr_t MeshPartTexture = 0x2c0;
    ...
    inline constexpr uintptr_t PlatformStatePointer = 0x2513d21e;
    ...
    inline constexpr uintptr_t SpawnLocationAllowTeamChangeOnTouch = 0x188;
    inline constexpr uintptr_t SpawnLocationEnabled = 0x189;
    inline constexpr uintptr_t SpawnLocationForcefieldDuration = 0x180;
    inline constexpr uintptr_t SpawnLocationNeutral = 0x18a;
    ...
    inline constexpr uintptr_t SurfaceAlphaMode = 0x288;
    inline constexpr uintptr_t SurfaceColor = 0x270;
    inline constexpr uintptr_t SurfaceColorMap = 0xc8;
    inline constexpr uintptr_t SurfaceEmissiveMaskContent = 0xf8;
    inline constexpr uintptr_t SurfaceEmissiveStrength = 0x28c;
    inline constexpr uintptr_t SurfaceEmissiveTint = 0x27c;
    ...
    inline constexpr uintptr_t TerrainMaterialColors = 0x438;
    ...
    inline constexpr uintptr_t ToolEnabled = 0x4b9;
    ...
    inline constexpr uintptr_t UnionOperationAssetId = 0x290;
    ...
    inline constexpr uintptr_t WorldAirProperties = 0x0;
