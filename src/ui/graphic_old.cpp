...
bool graphic::imgui()
{
    ...
    // Tahoma does not have Cyrillic ΓÇö use Arial or Segoe UI as Cyrillic fallback
...
namespace color
{
    // ΓöÇΓöÇ Ghost Sigil inspired palette ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    static void refresh()
    {
        // Base window ΓÇö deep dark with slight blue-purple tint
...
namespace ui
{
    ...
    static bool sliderfloat(const char* label, float* v, float mn, float mx, const char* fmt = "%.2f")
    {
        ...
        // Knob ΓÇö grows slightly on hover
    ...
    struct card {
        static bool begin(const char* id, ImVec2 size, const char* title = nullptr)
        {
            ...
            // Ghost SigilΓÇôstyle frosted glass card
...
namespace hud
{
    ...
    static bool keylive(bool enabled, ImGuiKey key, ImKeyBindMode mode)
    {
        ...
        return true; // Toggle ΓÇö always on when enabled
    }
    ...
    {
        // Ghost Sigil style ΓÇö dark glass pill with accent line
        const float R = 8.f;
        // Shadow
        ...
        // "unknownware" brand ΓÇö accent colored
    ...
    static void hotkey(ImDrawList* dl, ImVec2 p, ImVec2 s, bool hovered, bool active)
    {
        ...
        // Build bind list ΓÇö every configured keybind
    ...
    static void render(bool movable)
    {
        ...
        // ΓöÇΓöÇ Notifications panel (damage log) ΓÇö only visible when menu is open ΓöÇΓöÇ
...
void graphic::menu()
{
    ...
    // ΓöÇΓöÇ Ghost Sigil window chrome ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // Main window fill ΓÇö deep dark with subtle purple tint
    ...
    // ΓöÇΓöÇ Sidebar background ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇ Header background ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    DL->AddRectFilled(WP + ImVec2(1.f, 1.f),
    ...
    // ΓöÇΓöÇ Logo ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    {
    ...
    // ΓöÇΓöÇ Ghost Sigil sliding pill nav ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    {
    ...
    if (Section == 5)
    {
        // ΓöÇΓöÇ Game Selector ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        struct GameEntry {
            const char* name;
            const char* desc;
            const char* placeId;
        ...
        if (ui::card::begin("##gs", { bInW, bInH }, "GAME SELECTOR"))
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (gt > 0.05f)
                {
                    ...
                    // Click ΓåÆ open Roblox deeplink
                    if (gclk)
                    {
                        char link[128];
